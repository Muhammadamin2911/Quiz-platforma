      ...
      <div className="admin-profile-card">
        ...
        <div className="profile-details">
          <div className="detail-item">
            ...
            <span className="value">Muhammadamin</span>
          </div>
          
          <div className="detail-item">
            <span className="label">Telefon:</span>
            <span className="value">+998200001210</span>
          </div>
        </div>

        <div className="action-buttons">
          <a href="https://t.me/M_deweloper" target="_blank" rel="noreferrer" className="btn telegram-btn">
